...
while cap.isOpened():
    ...
    frame_ready.set()
    # 현재 프레임 표시
    # detect_result = detect_block_yolo()
    # if detect_result:
    #     cx, cy, w, color = detect_result
    #     distance_to_object = calculate_distance_to_object(w)
    #     cv2.putText(frame, f"Distance: {distance_to_object:.2f} mm", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
